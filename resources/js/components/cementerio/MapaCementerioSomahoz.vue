...
const props = defineProps({
  ...
  // items se mantiene como prop por compatibilidad pero no se renderiza
  items:        { type: Array, default: () => [] },
  capasActivas: { type: Array, default: () => ['zona', 'bloque'] },
  // Zonas y bloques con coordenadas
...
<style scoped>
.map-shell { background: white; position: relative; }
